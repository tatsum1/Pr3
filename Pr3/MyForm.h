...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"¬вести 11 ц≥лих чисел та обчислити суму т≥льки двоцифрових елемент≥в.";
			// 
			// button1
			// 
			...
			this->label2->Text = L"¬вед≥ть 11 ц≥лих чисел";
			// 
			// MyForm
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		richTextBox1->Text = "—ума двоцифрових чисел: " + sum.ToString();
	}
